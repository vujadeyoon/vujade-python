...
#
# Title: bash_s3_download.sh
# Description: A bash script file to download a file from the AWS S3 to the local file system.
...
#
# Usage: bash ./vujade/bash/bash_s3_download.sh <NAME_FILE> <NAME_BUCKET> <PATH_REMOTE_BASE>
#
#
path_curr=$(pwd)
...
#
#
echo "[bash_s3_download.sh] Finish to download the ${path_local} from S3://${name_bucket}/${path_remote}."
#
#
