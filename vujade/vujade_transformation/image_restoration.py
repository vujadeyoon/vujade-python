...
Title: image_restoration.py
Description: A transformation module for image_restoration
"""
...
class Compose(object):
    ...
    def __call__(self, _input: object, _target: object) -> object:
        for trans in self.co_transforms:
            _input, _target = trans(_input, _target)
